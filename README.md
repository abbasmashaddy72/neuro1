# Neuro 1 Project Installation Guide

## Overview

Neuro 1 is a project built with Laravel and Vite, utilizing two separate Tailwind configurations for the backend and frontend. This guide provides instructions for installing and running the project.
...
1. **Clone the repository:**
    ...
    ```
    git clone https://github.com/abbasmashaddy72/neuro1.git
    cd neuro1
    ```
