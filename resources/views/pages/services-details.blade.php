                    ...
                    <div class="row mrg30">
                            ...
                            <div class="post-detail w-100">
                                <div class="post-feat-img serv-detail-img brd-rd10 position-relative overflow-hidden w-100">
                                    ...
                                    <span class="serv-post-authr position-absolute"><i class="fas fa-user thm-clr"></i><a
                                            href="archive.html" title="">James Smith</a></span>
                                </div>
                                <div
                                    class="post-detail-meta-wrap d-flex flex-wrap justify-content-between align-items-center w-100">
                                    <ul class="meta3 mb-0 d-inline-flex flex-wrap list-unstyled">
                                        <li><i class="fas fa-tag thm-clr"></i><a href="javascript:void(0);"
                                                title="">Chrity</a>, <a href="javascript:void(0);" title="">poor</a>, <a
                                                href="javascript:void(0);" title="">people</a>, <a
                                                href="javascript:void(0);" title="">ideas</a></li>
                                    </ul>
                                    <div class="social-links5 d-inline-flex flex-wrap align-items-center">
                                        ...
                                        <a class="rounded-circle facebook-hvr" href="https://www.facebook.com/"
                                            title="Facebook" target="_blank"><i class="fab fa-facebook-f"></i></a>
                                        <a class="rounded-circle youtube-hvr" href="https://www.youtube.com/"
                                            title="Youtube" target="_blank"><i class="fab fa-youtube"></i></a>
                                        <a class="rounded-circle linkedin-hvr" href="https://www.linkedin.com/"
                                            title="Linkedin" target="_blank"><i class="fab fa-linkedin-in"></i></a>
                                        <a class="rounded-circle rss-hvr" href="https://rss.com/" title="RSS"
                                ...
                                <p class="mb-0">At vero eos et accusamus et iusto odio dignissimos ducimus qui
                                    ...
                                    excepturi sint occaecati cupiditate non provident, similique sunt in culpa qui <a
                                        href="javascript:void(0);" title="">officia deserunt</a> mollitia animi, id est
                                    ...
                                    quod maxime placeat <a href="javascript:void(0);" title="">facere possimus</a>, omnis
                                    voluptas assumenda est, omnis dolor repellendus. Temporibus autem quibusdam et aut
                                    officiis debitis aut rerum <a href="javascript:void(0);" title="">necessitatibus</a>
                                ...
                                <p class="mb-0">No one rejects, dislikes, or avoids pleasure itself, because it is
                                    pleasure, but because those who do not know how to pursue pleasure rationally <a
                                        href="javascript:void(0);" title="">encounter</a> consequences that are extremely
                                    painful. Nor again is there anyone who loves or pursues or desires to obtain pain of
                                    itself, because it is pain, but because occasionally <a href="javascript:void(0);"
                                ...
                                <p class="mb-0">Lorem ipsum dosectetur adipisicing elit, sed ectetur Nulla
                                    fringilla purus at leo dignisntum cursus nisl aliquam. <a href="javascript:void(0);"
                                        title="">Aliquam</a> et elit eu nunci consectetur Nulla fringillatetur adipisicing
                                    elit mentum accumsan leo vel tempor.</p>
                        ...
                        <div class="col-md-6 col-sm-8 col-lg-4">
                            <aside class="sidebar w-100">
                                <div class="widget-box v3 request-consult-wrap2 z1 brd-rd10 position-relative overflow-hidden blue-layer3 opc98 text-center w-100"
                                    style="background-image: url(web-assets/images/pattern-bg1.jpg)">
                                    ...
                                    <form class="w-100 d-inline-block">
                                        <div class="field-box"><input class="brd-rd5" type="text"
                                                placeholder="Complete Name *"></div>
                                        <div class="field-box"><input class="brd-rd5" type="email"
                                                placeholder="Email Address *"></div>
                                        <div class="field-box"><input class="brd-rd5" type="tel"
                                                placeholder="Phone No *"></div>
                                        <div class="btn-box"><button
                                                class="thm-btn scndry-bg brd-rd5 position-relative overflow-hidden"
                                                type="submit">Next Step</button></div>
                                    </form>
                                </div>
                                <div class="widget-box v3 brd-rd10 bg-color6 services_widget overflow-hidden w-100">
                                    ...
                                    <ul class="mb-0 list-unstyled w-100">
                                        <li><a href="{{ route('services-details') }}" title="">Couple Counseling</a></li>
                                        <li><a href="{{ route('services-details') }}" title="">Family Problem</a></li>
                                        <li><a href="{{ route('services-details') }}" title="">Dating & Relation</a></li>
                                        <li><a href="{{ route('services-details') }}" title="">Anxiety Disorder</a></li>
                                        <li><a href="{{ route('services-details') }}" title="">Depression Problem</a></li>
                                        <li><a href="{{ route('services-details') }}" title="">Personal Meeting</a></li>
                                    </ul>
                                </div>
